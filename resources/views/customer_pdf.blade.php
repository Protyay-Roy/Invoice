...
<body style="width: 100%; padding:0px; margin:0px">
    ...
    <p style="font-weight: 500; font-size: 16px; margin-bottom: 0px">DHARANDA, DINAJPUR ROAD, BANGL HILI, HAKIMPUR,
        DINAJPUR, BANGLADESH.</p>
    <p style="font-weight: 400; font-size: 15px; margin-bottom: 0px">Phone: 01711-413307 - 01711286437</p>
    <p style="font-weight: 400; font-size: 15px; margin-bottom: 0px">Email: <a href="rktrading65@yahoo.com"
            style="text-decoration: none; color: #444444">rktrading65@yahoo.com</a></p>
    ...
    <p style="font-weight: 400; font-size: 14px; margin-bottom: 5px">Party's Report Created:
    ...
    <table class="table table-bordered mb-5">
        ...
        <tbody>
            ...
            @foreach ($transections as $transection)
                ...
                @foreach ($invoic_items as $items)
                    @php
                        if ($transection->type == 'C_PURCHASE') {
                            $total_balance -= $items->price;
                        } else {
                            $total_balance += $items->price;
                        }
                ...
                @if (
                    ($transection->type == 'INVOICE' && $transection->credit > 0) ||
                        ($transection->type == 'C_PURCHASE' && $transection->debit > 0) ||
